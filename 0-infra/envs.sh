...
PROJECT_NUMBER=18311747017
PROJECT_ID=moodle-gke-sandbox
REGION=us-central1
ZONE=$REGION-a
...
# NAT config
NAT_CONFIG=moodle-gateway
NAT_ROUTER=moodle-router

# db specific variables
GKE_NAME=moodle-gke-sandbox
MYSQL_INSTANCE_NAME=moodle-mysql
MYSQL_ROOT_PASSWORD=
MYSQL_DB=moodle
MYSQL_MOODLE_DB_CHARSET=utf8mb4
MYSQL_MOODLE_DB_COLLATION=utf8mb4_unicode_ci
